...
$component = [
    ...
    'sections'  => [
        'header'  => 'Plinker PHP RPC client/server makes it really easy to link and execute PHP component classes on remote systems, while maintaining the feel of a local method call.',
        'install' => '',
        'client'  => '',
        'server'  => '',
        'methods' => [
